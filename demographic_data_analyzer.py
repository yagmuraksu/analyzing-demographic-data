...
def calculate_demographic_data(print_data=True):
    # Read data from file
    df = pd.read_csv("/Users/yagmuraksu/Library/CloudStorage/GoogleDrive-yagmuraksu@gmail.com/My Drive/FEBRUARY 2023 ML COURSE NOTES/freecodecamp Data Analysis Certificate/Project 2/adult.data.csv")
    num_of_people = df.shape[0]
    ...
    percentage_bachelors = round(total_bachelors /num_of_people*100,1)
    ...
    highest_earning_country = (df[df['salary']=='>50K']['native-country'].value_counts()/df['native-country'].value_counts()).sort_values().dropna().index[-1]
